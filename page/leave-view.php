          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="progress" style="height: 10px;">
                <div class="progress-bar" role="progressbar" style="width: 100%; background-color: #237ab7;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            <div class="col-md-6 mb-3">
...
<div class="modal fade" id="leaveRequestModal" tabindex="-1" aria-labelledby="leaveRequestModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form id="leaveForm" action="leave.php" method="POST">
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="date" class="form-control" id="startDateModal" required>
            </div>
            <div class="col-md-6 mb-3">
              <label for="endDateModal" class="form-label">Date To</label>
              <input type="date" class="form-control" id="endDateModal" required>
            </div>
          </div>

          <div class="mb-3">
            <label for="reasonModal" class="form-label">Reason</label>
            <textarea class="form-control" id="reasonModal" rows="3"
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-success" id="submitLeaveButton">
