...
<aside id="sidebarMenu" class="sidebar desktop-sidebar shadow-lg">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="mobile-sidebar">
  ...
  <div class="offcanvas-body">
    <nav class="nav flex-column">
      <a class="nav-link active" href="#" data-bs-target="#dashboard-view">Dashboard</a>
      <a class="nav-link" href="#" data-bs-target="#attendance-view">My Attendance</a>
      <a class="nav-link" href="#" data-bs-target="#leave-view">My Leave</a>
      <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#payslipModal">My Payslip</a>
    </nav>
  </div>
</div>